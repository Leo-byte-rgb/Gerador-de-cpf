...
function gerar() {
  ...
  resultado.innerHTML = "CPF GERADO: ".concat(gera.geraNovoCpf());
}
...
var GeraCPF = /*#__PURE__*/function () {
  ...
  _createClass(GeraCPF, [{
    ...
    } // gera um número entre 100000000 e 999999999 
    ...
    value: function geraNovoCpf() {
      ...
      var digito2 = _ValidaCPF__WEBPACK_IMPORTED_MODULE_0__.default.geraDigito(cpfSemDigito + 1);
...
var ValidaCPF = /*#__PURE__*/function () {
  ...
  _createClass(ValidaCPF, [{
    ...
    value: function geraNovoCpf() {
      ...
      this.novoCPF = cpfParcial + digito1 + digito2; //gera cpf novo
    }
  }, {
    key: "valida",
    ...
    value: function geraDigito(cpfParcial) {
      var total = 0;
      var reverse = cpfParcial.length + 1; //valor do array + 1
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          var i = _step.value;
          // para cada valor do cpf parcial, faça
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "body {\n    background-color: #fff1e6;\n    text-align: center;\n   \n}\nh1 {\n    color: #cb997e;\n}\n.Button {\n    background-color: #a5a58d;\n    outline: none;\n    width: 150px;\n    height: 35px;\n    border: 0;\n    border-radius: 0.2em;\n    cursor: pointer;\n    color: #f0efeb;\n    font-size: 20px;\n    font-weight: bold;\n    transition: 0.5s\n}\n.Button:hover {\n    background-color: #b7b7a4;\n    transform: translateY(-2px);\n}\n.resultado {\n    color: #cb997e;\n    font-size: 30px;\n    margin-top: 100px;\n    \n}", "",{"version":3,"sources":["webpack://./src/assets/css/style.css"],"names":[],"mappings":"AAAA;IACI,yBAAyB;IACzB,kBAAkB;;AAEtB;AACA;IACI,cAAc;AAClB;AACA;IACI,yBAAyB;IACzB,aAAa;IACb,YAAY;IACZ,YAAY;IACZ,SAAS;IACT,oBAAoB;IACpB,eAAe;IACf,cAAc;IACd,eAAe;IACf,iBAAiB;IACjB;AACJ;AACA;IACI,yBAAyB;IACzB,2BAA2B;AAC/B;AACA;IACI,cAAc;IACd,eAAe;IACf,iBAAiB;;AAErB","sourcesContent":["body {\n    background-color: #fff1e6;\n    text-align: center;\n   \n}\nh1 {\n    color: #cb997e;\n}\n.Button {\n    background-color: #a5a58d;\n    outline: none;\n    width: 150px;\n    height: 35px;\n    border: 0;\n    border-radius: 0.2em;\n    cursor: pointer;\n    color: #f0efeb;\n    font-size: 20px;\n    font-weight: bold;\n    transition: 0.5s\n}\n.Button:hover {\n    background-color: #b7b7a4;\n    transform: translateY(-2px);\n}\n.resultado {\n    color: #cb997e;\n    font-size: 30px;\n    margin-top: 100px;\n    \n}"],"sourceRoot":""}]);
// Exports
